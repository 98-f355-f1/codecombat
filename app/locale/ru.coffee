...
#    request_quote: "Запросить цену"
    ...
    educator: "Учитель"
    student: "Ученик"
#    our_coding_programs: "Наши программы для кодирования"
    codecombat: "CodeCombat"
    ozaria: "Ozaria"
#    codecombat_blurb: "Наша оригинальная игр по программированию. Рекомендуется для родителей, частных лиц, учителей, и учеников, которые хотят испытать одну из самых любимых игр по программированию в мире."
#    ozaria_blurb: "Игра приключения и Программа компьютерных наук, где студенты могут овладеть утраченным искусством программирования, чтобы спасти мир. Рекомендуется для и учителей, и учеников."
#    try_codecombat: "Попробуй CodeCombat"
#    try_ozaria: "Попробуй Ozaria"
